...
export class ConfigHelper {
	...
	public static getEnvArgsConfig(): IKeyValueConfigItem[] {
		return this.config.get('envArgs');
	}
	...
	public static mapKeyValueConfigToEnvArgs(keyValueItems: IKeyValueConfigItem[]): Object {
	...
	public static mapEnvArgsToString(keyValueObject: Object): string {
